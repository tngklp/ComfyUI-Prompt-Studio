...
**ComfyUI extension**: **1.1.2** · [Download ZIP](../../releases/download/v1.1.2/Prompt-Studio-ComfyUI-v1.1.2.zip) · [Installation](docs/INSTALLATION.md)

**Standalone for Windows**: **1.2.2** · [Download ZIP](../../releases/download/standalone-v1.2.2/Prompt-Studio-Standalone-Windows-v1.2.2.zip) · [Setup guide](standalone/README.md)
